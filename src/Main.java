...
public class Main implements Runnable {
    ...
    int winner;
    public boolean notTapped;


    // Main method definition: PSVM
    // This is the code that runs first and automatically
    public static void main(String[] args) {
        Main ex = new Main();   //creates a new instance of the game and tells GameLand() method to run
...
//        astro.printInfo();
        ob1 = new Hero((int)(Math.random() * 901), (int)(Math.random() * 601), 2, 0, 1);
        ob2 = new Hero((int)(Math.random() * 901), (int)(Math.random() * 601), 0, 4, 2);
        ob3 = new Hero((int)(Math.random() * 901), (int)(Math.random() * 601), 0, 3, 3);
        ob4 = new Hero((int)(Math.random() * 901), (int)(Math.random() * 601), 4, 0, 1);
        ob5 = new Hero((int)(Math.random() * 901), (int)(Math.random() * 601), 0, 5, 2);
        ob6 = new Hero((int)(Math.random() * 901), (int)(Math.random() * 601), 0, 3, 3);
        /** STEP 4: load in the image for your object **/
//        astroPic = Toolkit.getDefaultToolkit().getImage("astronaut.png");
        pastel = Toolkit.getDefaultToolkit().getImage("bg.png");
        ob1Pic = Toolkit.getDefaultToolkit().getImage("blue.png");
        ob2Pic = Toolkit.getDefaultToolkit().getImage("yellow.png");
        ob3Pic = Toolkit.getDefaultToolkit().getImage("speedy.png");
        ob4Pic = Toolkit.getDefaultToolkit().getImage("blue.png");
        ob5Pic = Toolkit.getDefaultToolkit().getImage("yellow.png");
        ob6Pic = Toolkit.getDefaultToolkit().getImage("speedy.png");
    }// GameLand()
...
//        imageDecision(ob6);
    ...
    public void imageDecision(Hero object){
        ...
        if (object.identity == 1){
            Image temp = Toolkit.getDefaultToolkit().getImage("speedy.png");
            g.drawImage(temp, object.xpos, object.ypos, object.width, object.height, null);
        }
        else if (object.identity == 2){
            Image temp = Toolkit.getDefaultToolkit().getImage("yellow.png");
            g.drawImage(temp, object.xpos, object.ypos, object.width, object.height, null);
        }
        else {
            Image temp = Toolkit.getDefaultToolkit().getImage("blue.png");
            g.drawImage(temp, object.xpos, object.ypos, object.width, object.height, null);
        }
    }
